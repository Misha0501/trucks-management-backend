...
| UserEndpoints.cs | /users, /users/me, /contactpersons, /drivers (delete) |
| CompanyEndpoints.cs | /companies |
| ClientEndpoints.cs | /clients (Routes namespace) |
| DriverEndpoints.cs | /drivers, /drivers/{id}/contracts, periods, week |
| CarEndpoints.cs | /cars, /car-files |
| RideEndpoints.cs | /rides |
| PartRideEndpoints.cs | /partrides |
| PartRideFilesEndpoint.cs | /partride-files |
| DisputeRoute.cs | /disputes |
| RideAssignmentEndpoints.cs | /rides/{id}/assign, hours, details |
| RideExecutionEndpoints.cs | /rides/{id}/my-execution, executions |
| RideExecutionFileEndpoints.cs | /rides/{id}/my-execution/files |
| RideExecutionCommentEndpoints.cs | /rides/{id}/executions/{driverId}/comments |
| RideExecutionDisputeEndpoints.cs | /execution-disputes |
| WeeklyPlanningEndpoints.cs | /weekly-planning |
| DailyPlanningEndpoints.cs | /daily-planning |
| AvailabilityEndpoints.cs | /availability |
| CapacityTemplateEndpoints.cs | /capacity-templates |
| RideWeekSubmissionEndpoints.cs | /rides/weeks-to-submit, /rides/week |
| RidePeriodEndpoints.cs | /rides/periods |
| WeekToSubmitEndpoints.cs | /weeks-to-submit |
| ReportEndpoints.cs | /reports |
| DriverInvoiceEndpoints.cs | /drivers/{id}/weeks/{week}/invoice |
| EmployeeContractsEndpoints.cs | /employee-contracts |
| TelegramEndpoints.cs | /telegram |
| FileUploadsEndpoints.cs | /temporary-uploads |
| RateEndpoints.cs, SurchargeEndpoints.cs | /rates, /surcharges |
| CharterEndpoints.cs, UnitEndpoints.cs | /charters, /units |
| HoursCodeEndpoints.cs, HoursOptionEndpoints.cs | /hourscodes, /hoursoptions |
| RoleEndpoints.cs | /roles |
