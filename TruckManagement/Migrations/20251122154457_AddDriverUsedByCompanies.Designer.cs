...
namespace TruckManagement.Migrations
{
    ...
    [Migration("20251122154457_AddDriverUsedByCompanies")]
    partial class AddDriverUsedByCompanies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckManagement.Entities.Car", b =>
                {
                    ...
                    b.Property<DateOnly?>("LeasingEndDate")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("LeasingStartDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("TruckManagement.Entities.CarUsedByCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TruckManagement.Entities.DriverUsedByCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DriverId", "CompanyId")
                        .IsUnique();

                    b.ToTable("DriverUsedByCompanies");
                });
            ...
            modelBuilder.Entity("TruckManagement.Entities.RideDriverExecution", b =>
                {
                    ...
                    b.Property<decimal?>("ExceedingContainerWaitingTime")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("ExtraKilometers")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("HourlyCompensation")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("TruckManagement.Entities.CarUsedByCompany", b =>
                {
                    b.HasOne("TruckManagement.Entities.Car", "Car")
                        .WithMany("UsedByCompanies")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TruckManagement.Entities.Company", "Company")
                        .WithMany("CarsUsedByThisCompany")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TruckManagement.Entities.DriverUsedByCompany", b =>
                {
                    b.HasOne("TruckManagement.Entities.Company", "Company")
                        .WithMany("DriversUsedByThisCompany")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TruckManagement.Entities.Company", b =>
                {
                    b.Navigation("CarsUsedByThisCompany");
                    ...
                    b.Navigation("DriversUsedByThisCompany");
                });
